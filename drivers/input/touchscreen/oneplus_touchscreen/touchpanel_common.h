...
//#define CONFIG_ONEPLUS_TP_APK please define this in arch/arm64/configs
...
struct touchpanel_data {
	...
	int firmware_update_type;                           /*firmware_update_type: 0=check firmware*/
								/*version 1=force update; 2=for FAE debug*/
	...
	bool skip_suspend_operate;                          /*LCD and TP is in one chip,lcd power off in*/
						/*suspend at first, can not operate i2c when tp suspend*/
...
//#endif
    ...
    struct oneplus_touchpanel_operations *ts_ops;          /*call_back function*/
...
struct oneplus_touchpanel_operations {
